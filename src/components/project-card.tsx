...
function ProjectGradient({ title }: { title: string }) {
  ...
  return (
    <div
      className="relative w-full h-48 overflow-hidden transition-transform duration-300 group-hover:scale-[1.03]"
      style={{
      ...
      <div className="group flex flex-col h-full cursor-pointer">
        ...
        <div className="p-6 flex flex-col gap-3 flex-1">
          <div className="flex items-start justify-between gap-2">
            ...
            <a
              href={detailHref}
              className="text-muted-foreground hover:text-foreground transition-all duration-200 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-sm"
